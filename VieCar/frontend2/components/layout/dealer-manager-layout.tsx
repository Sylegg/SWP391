...
const navigationItems = [
  ...
  {
    title: "Danh mục xe",
    href: "/dashboard/dealer-manager/vehicles",
    icon: Car
  },
  {
    title: "Khách hàng",
    href: "/dashboard/dealer-manager/customers",
    icon: Users
  },
  {
    title: "Lịch lái thử",
    href: "/dashboard/dealer-manager/test-drives",
    icon: Calendar
  },
  {
    title: "Báo giá",
    href: "/dashboard/dealer-manager/quotes",
    icon: FileText
  },
  {
    title: "Đơn hàng",
    href: "/dashboard/dealer-manager/orders",
    icon: ShoppingCart
  },
  {
    title: "Thanh toán",
  ...
  },
  {
    ...
    href: "/dashboard/dealer-manager/support",
    icon: MessageSquare
  },
  {
    title: "Báo cáo kinh doanh",
    href: "/dashboard/dealer-manager/business-reports",
    icon: BarChart
  },
  {
    title: "Cài đặt đại lý",
    href: "/dashboard/dealer-manager/settings",
    icon: Settings
  }
];
