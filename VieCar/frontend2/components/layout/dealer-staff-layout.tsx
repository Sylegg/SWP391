...
interface DealerStaffLayoutProps {
  children: ReactNode;
}
...
const navigationItems = [
  ...
  {
    title: "Danh mục xe",
    href: "/dashboard/dealer-staff/vehicles",
    icon: Car
  },
  {
    title: "Khách hàng",
  ...
  {
    title: "Báo giá",
    href: "/dashboard/dealer-staff/quotes",
    icon: FileText
  },
  {
    title: "Đơn hàng",
  ...
  },
  {
    ...
    href: "/dashboard/dealer-staff/support",
    icon: MessageSquare
  },
  {
    title: "Báo cáo bán hàng",
    href: "/dashboard/dealer-staff/sales-reports",
    icon: BarChart
  }
];

export default function DealerStaffLayout({ children }: DealerStaffLayoutProps) {
