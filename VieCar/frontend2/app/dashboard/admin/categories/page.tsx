...
export default function AdminCategoriesPage() {
  ...
  const handleCreate = async () => {
    ...
    if (!formData.name || !formData.brand || !formData.version || !formData.type) {
      toast({
        variant: "destructive",
        title: "Lỗi",
        description: "Vui lòng điền đầy đủ các trường: Tên, Thương hiệu, Phiên bản và Loại xe",
      });
      return;
    }
    ...
    if (formData.basePrice <= 0) {
      toast({
        variant: "destructive",
        title: "Lỗi",
        description: "Giá cơ bản phải lớn hơn 0",
      });
      return;
    }
    ...
    if (formData.warranty < 0) {
      toast({
        variant: "destructive",
        title: "Lỗi",
        description: "Bảo hành không thể âm",
      });
      return;
    }
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Quản lý danh mục sản phẩm xe điện (Admin)
              </p>
            </div>
