...
public class VnpayService {
    ...
    public VnpayRes create() throws UnsupportedEncodingException {
...
//        String vnp_IpAddr = VnpayConfig.getIpAddress(req);
        ...
        vnp_Params.put("vnp_Amount", String.format("%d", amount));
        ...
        VnpayRes vnpayRes = new VnpayRes();
        vnpayRes.setStatus("Ok");
        vnpayRes.setMsg("Successfully");
        vnpayRes.setUrl(paymentUrl);
        return vnpayRes;
