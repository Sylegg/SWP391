...
public class OrderRes {
    ...
    public String getProductVin() {
        return productVin;
    }

    public void setProductVin(String productVin) {
        this.productVin = productVin;
    }
    ...
    public Double getProductBattery() {
        return productBattery;
    }

    public void setProductBattery(Double productBattery) {
    ...
    public Integer getProductHP() {
        return productHP;
    }

    public void setProductHP(Integer productHP) {
        this.productHP = productHP;
    }

    public Integer getProductTorque() {
        return productTorque;
    }

    public void setProductTorque(Integer productTorque) {
        this.productTorque = productTorque;
    }
